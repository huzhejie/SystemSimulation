...
public class ThreeVolumeChangeUI extends NodeUI {
    private Control.ThreeVolumeChange switzh = null;
...
//    }
    public void paintBody(Graphics2D g) {
        ...
        switzh = (Control.ThreeVolumeChange) this.getElement();
        ...
        g.drawOval(x + width / 2 - width / 8, y + width / 4, width / 2, width / 2);
        g.drawLine(x + width / 2 - width / 8 + width / 4, y + width / 4 + width / 4, x + width / 2 - width / 8 + width / 4, y + width / 4 + width / 8);
        g.drawLine(x + width / 2 - width / 8 + width / 4, y + width / 4 + width / 4, x + width / 2, y + 5 * width / 8);
        g.drawLine(x + width / 2 - width / 8 + width / 4, y + width / 4 + width / 4, x + width * 3 / 4, y + 5 * width / 8);
